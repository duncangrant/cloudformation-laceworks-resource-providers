...
export class Transformer {
     ...
     * (see https://github.com/cloudsoft/cloudformation-cli-typescript-plugin/blob/d6a9fe232b6dff4c56b0c3306a7e4bda84bd37ec/python/rpdk/typescript/utils.py#L83-L86)
     */
